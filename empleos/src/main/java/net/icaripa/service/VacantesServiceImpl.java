...
public class VacantesServiceImpl implements IVacantesService {
	...
	public VacantesServiceImpl() {
		...
		try {
			...
			vacante1.setFecha(sdf.parse("08-11-2023"));
			...
			vacante2.setFecha(sdf.parse("09-11-2023"));
			...
			vacante3.setDescripcion("Empresa internacional solicita Ing. mecanico para mantenimiento de la instalacion electrica.");
			...
			vacante4.setFecha(sdf.parse("11-02-2023"));
